...
unsafe extern "C" {
    pub(crate) static NSApp: *mut AnyObject;
    pub(crate) static NSAppearanceNameAqua: *const AnyObject;
    pub(crate) static NSAppearanceNameDarkAqua: *const AnyObject;
}

// MARK: CoreGraphics structs
#[derive(Clone, Copy)]
#[repr(C)]
...
// MARK: NSString
#[repr(transparent)]
pub(crate) struct NSString(*mut AnyObject);
...
impl NSString {
    pub(crate) fn from_str(str: impl AsRef<str>) -> Self {
        ...
        unsafe {
            ...
            let ns_string: *mut AnyObject = msg_send![ns_string, initWithBytes:str.as_ptr().cast::<c_void>(), length:str.len(), encoding:NS_UTF8_STRING_ENCODING];
