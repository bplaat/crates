...
// MARK: GIO
#[repr(C)]
pub(crate) struct GInputStream(u8);
#[link(name = "gio-2.0")]
unsafe extern "C" {
...
// MARK: Soup
#[repr(C)]
pub(crate) struct SoupMessageHeaders(u8);
...
// MARK: WebKitGtk
#[repr(C)]
pub(crate) struct WebKitWebContext(u8);
#[repr(C)]
...
#[repr(C)]
pub(crate) struct WebKitURISchemeResponse(u8);
#[repr(C)]
pub(crate) struct WebKitURISchemeRequest(u8);
