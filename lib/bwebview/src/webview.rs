...
use crate::platforms::{PlatformMonitor, PlatformWebview};
...
pub trait WebviewHandler {
    /// Called when an IPC message is received
    fn ipc_message(&mut self, webview: &mut Webview, message: &str) {}
}
...
pub struct WebviewBuilder<'a> {
    ...
    pub(crate) embed_assets_get: Option<fn(&str) -> Option<rust_embed::EmbeddedFile>>,
    #[cfg(feature = "rust-embed")]
    pub(crate) internal_http_server_port: Option<u16>,
    #[cfg(feature = "rust-embed")]
    pub(crate) internal_http_server_expose: bool,
    #[cfg(feature = "rust-embed")]
    pub(crate) internal_http_server_handle:
        Option<fn(&small_http::Request) -> Option<small_http::Response>>,
