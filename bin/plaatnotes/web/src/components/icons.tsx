...
export const PinIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M16 12V4h1V2H7v2h1v8l-2 2v2h5.2v6h1.6v-6H18v-2l-2-2z" class={c} />
);
export const ArchiveArrowDownIcon = ({ class: c }: { class?: string }) => (
    <Icon
        path="M20.54 5.23l-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27zM6.24 5h11.52l.83 1H5.42l.82-1zM5 19V8h14v11H5zm8.45-9h-2.9v3H8l4 4 4-4h-2.55v-3z"
        class={c}
    />
);
export const ArchiveArrowUpIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const RestoreIcon = ({ class: c }: { class?: string }) => (
    <Icon
        path="M13 3a9 9 0 0 0-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42A8.954 8.954 0 0 0 13 21a9 9 0 0 0 0-18z"
        class={c}
    />
);
export const DeleteIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 002 2h8a2 2 0 002-2V7H6v12z" class={c} />
);
export const DeleteOutlineIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const MagnifyIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const NoteTextIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const DownloadIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M19 9h-4V3H9v6H5l7 7 7-7zm-8 2V5h2v6h1.17L12 13.17 9.83 11H11zm-6 7h14v2H5v-2z" class={c} />
);
export const FormatBoldIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const FormatItalicIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M10 4v3h2.21l-3.42 8H6v3h8v-3h-2.21l3.42-8H18V4h-8z" class={c} />
);
export const FormatUnderlineIcon = ({ class: c }: { class?: string }) => (
    <Icon
        path="M12 17c3.31 0 6-2.69 6-6V3h-2.5v8c0 1.93-1.57 3.5-3.5 3.5S8.5 12.93 8.5 11V3H6v8c0 3.31 2.69 6 6 6zm-7 2v2h14v-2H5z"
        class={c}
    />
);
export const FormatStrikethroughIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M10 19h4v-3h-4v3zM5 4v3h5v3h4V7h5V4H5zM3 14h18v-2H3v2z" class={c} />
);
export const FormatQuoteOpenIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z" class={c} />
);
export const FormatListBulletedIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const FormatListNumberedIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const CodeTagsIcon = ({ class: c }: { class?: string }) => (
    <Icon path="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z" class={c} />
);
export const CodeBracesIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const LinkIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const MinusIcon = ({ class: c }: { class?: string }) => <Icon path="M19 13H5v-2h14v2z" class={c} />;
...
export const LockIcon = ({ class: c }: { class?: string }) => (
    <Icon
...
export const HistoryIcon = ({ class: c }: { class?: string }) => (
    <Icon
        path="M13 3a9 9 0 0 0-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42A8.954 8.954 0 0 0 13 21a9 9 0 0 0 0-18zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"
        class={c}
    />
);
