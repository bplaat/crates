...
fn main() {
    ...
    // Binman is useful without elevation. Administrative rules are gated at
    // runtime instead of forcing every launch through UAC.
    let execution_level = "asInvoker";
    let manifest = format!(
        r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" xmlns:asmv3="urn:schemas-microsoft-com:asm.v3" manifestVersion="1.0">
    <assemblyIdentity type="win32" name="Binman" version="{}.0" processorArchitecture="*"/>
    <dependency>
        <dependentAssembly>
