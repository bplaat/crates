...
use tasks::cx::{
    generate_cpp_tasks, generate_ld_tasks, generate_objc_tasks, generate_objcpp_tasks,
    generate_test_main,
};
...
use crate::tasks::android::{
    detect_android, generate_android_apk_tasks, generate_android_dex_tasks,
    generate_android_res_tasks, run_android_apk,
};
use crate::tasks::cx::{
    detect_bundle, detect_c, detect_cpp, detect_cx, detect_objc, detect_objcpp,
    generate_bundle_tasks, generate_c_tasks, run_bundle, run_ld, run_ld_tests,
};
...
fn main() {
    ...
    if detect_android() {
        ...
        generate_android_apk_tasks(&project, &mut executor);
    }
