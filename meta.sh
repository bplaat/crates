...
build_bundle() {
    ...
    cargo bundle --path bin/pixelfont
...
install() {
    ...
    if [ "$(uname)" = "Darwin" ]; then
        ...
        cp -r "target/bundle/pixelfont/Pixel Font Editor.app" /Applications
        ...
        build_install_windows pixelfont PixelFontEditor
        ...
        build_install_freedesktop pixelfont PixelFontEditor
