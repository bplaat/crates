...
- [qoi-appkit](lib/qoi-appkit) Shared AppKit image conversion for QOI applications
...
- [QOI Viewer](bin/qoi-viewer) A macOS QOI image viewer with [Quick Look preview](bin/qoi-viewer-preview) and [thumbnail](bin/qoi-viewer-thumbnail) extensions
